{{-- Corporate Professional Template 2025 - Login Notification --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #2563eb 0%, #1e40af 100%); padding: 45px 40px; text-align: center;">
                            ...
                            <div style="background: rgba(255,255,255,0.15); display: inline-block; padding: 6px 18px; border-radius: 20px; margin-bottom: 12px;">
                                <span style="color: #ffffff; font-size: 11px; font-weight: 600; letter-spacing: 1.5px;">SECURE ACCESS</span>
                            </div>
                            <h1 style="margin: 10px 0 0; color: #ffffff; font-size: 26px; font-weight: 700;">Login Request</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 45px 40px;">
                            ...
                            <p style="color: #475569; font-size: 15px; line-height: 1.8; margin: 0 0 30px;">
                                A login request has been initiated for your {{$name}} account. Click below within <strong style="color: #2563eb;">5 minutes</strong> to securely access your account.
                            </p>
                            <table role="presentation" style="width: 100%; background: #eff6ff; border-left: 4px solid #3b82f6; border-radius: 8px; margin: 30px 0;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <p style="margin: 0; color: #1e40af; font-size: 14px; line-height: 1.6;">
                                            <strong>🛡️ Security Notice:</strong> <span style="color: #475569;">Your credentials are protected with enterprise-grade encryption.</span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            <table role="presentation" style="width: 100%; margin: 35px 0 25px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{$link}}" style="display: inline-block; background: linear-gradient(135deg, #2563eb 0%, #1e40af 100%); color: #ffffff; text-decoration: none; padding: 16px 45px; border-radius: 8px; font-weight: 600; font-size: 15px; box-shadow: 0 4px 14px rgba(37,99,235,0.4);">
                                            Access Account →
                                        </a>
                                    </td>
                                </tr>
                            </table>
                            <p style="color: #64748b; font-size: 14px; margin: 25px 0 10px;">Alternative access link:</p>
                            <table role="presentation" style="width: 100%; background: #f8fafc; border-radius: 8px; border: 1px solid #e2e8f0;">
                                <tr>
                                    <td style="padding: 15px; word-break: break-all;">
                                        <p style="color: #2563eb; font-size: 12px; margin: 0; font-family: 'Courier New', Monaco, monospace;">{{$link}}</p>
                                    </td>
                                </tr>
                            </table>
