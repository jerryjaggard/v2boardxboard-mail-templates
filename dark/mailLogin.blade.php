{{-- Dark Professional Template 2025 - Login --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <table role="presentation" style="width: 100%; max-width: 620px; border-collapse: collapse; background: linear-gradient(180deg, #1e293b 0%, #0f172a 100%); border-radius: 16px; overflow: hidden; border: 1px solid rgba(148,163,184,0.1); box-shadow: 0 20px 60px rgba(0,0,0,0.5);">
                    <tr>
                        <td style="background: linear-gradient(135deg, rgba(59,130,246,0.15) 0%, rgba(37,99,235,0.1) 100%); padding: 45px 40px; text-align: center; border-bottom: 1px solid rgba(148,163,184,0.1);">
                            ...
                            <h1 style="margin: 0; color: #f1f5f9; font-size: 26px; font-weight: 700;">Login Request</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 45px 40px;">
                            ...
                            <p style="color: #cbd5e1; font-size: 15px; line-height: 1.8; margin: 0 0 30px;">
                                Login request for {{$name}}. Valid for <strong style="color: #3b82f6;">5 minutes</strong>.
                            </p>
                            <table role="presentation" style="width: 100%; background: rgba(59,130,246,0.05); border-left: 3px solid #3b82f6; border-radius: 8px; margin: 30px 0;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <p style="margin: 0; color: #3b82f6; font-size: 14px;">
                                            <strong>🛡️ Secure:</strong> <span style="color: #cbd5e1;">Enterprise-grade encryption.</span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            <table role="presentation" style="width: 100%; margin: 35px 0 20px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{$link}}" style="display: inline-block; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); color: #ffffff; text-decoration: none; padding: 16px 45px; border-radius: 10px; font-weight: 600; font-size: 15px; box-shadow: 0 4px 14px rgba(59,130,246,0.4);">
                                            Access Account
                                        </a>
                                    </td>
                                </tr>
