{{-- Aurora Template - Email Verification --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <table role="presentation" style="width: 600px; max-width: 100%; border-collapse: collapse; background: linear-gradient(180deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.02) 100%); border-radius: 24px; overflow: hidden; border: 1px solid rgba(255,255,255,0.1); box-shadow: 0 25px 80px rgba(0,0,0,0.5), 0 0 100px rgba(99,102,241,0.2), 0 0 60px rgba(236,72,153,0.1);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, rgba(99,102,241,0.3) 0%, rgba(139,92,246,0.3) 25%, rgba(236,72,153,0.3) 50%, rgba(34,211,238,0.3) 75%, rgba(16,185,129,0.3) 100%); padding: 50px 40px; text-align: center; position: relative;">
                            ...
                            <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: 600; text-shadow: 0 0 30px rgba(139,92,246,0.8);">✉️ Email Verification</h1>
                        </td>
                    </tr>
                    <!-- Animated Aurora Bar -->
                    <tr>
                    ...
                    <tr>
                        <td style="padding: 45px;">
                            ...
                            <p style="color: rgba(255,255,255,0.7); font-size: 16px; line-height: 1.8; margin: 0 0 30px;">Your magical verification code has arrived. It shimmers for 5 minutes!</p>
                            <div style="text-align: center; margin: 40px 0;">
                                <div style="display: inline-block; background: linear-gradient(135deg, rgba(99,102,241,0.4) 0%, rgba(236,72,153,0.4) 100%); padding: 30px 60px; border-radius: 20px; border: 1px solid rgba(255,255,255,0.2); box-shadow: 0 0 40px rgba(139,92,246,0.4), inset 0 0 30px rgba(255,255,255,0.05);">
                                    <span style="color: #ffffff; font-size: 40px; font-weight: bold; letter-spacing: 12px; text-shadow: 0 0 20px rgba(255,255,255,0.5);">{{$code}}</span>
                                </div>
                            </div>
                            <p style="color: rgba(255,255,255,0.5); font-size: 14px; text-align: center; margin: 30px 0 0;">Didn't request this? Let it fade away ✨</p>
                            <div style="text-align: center; margin-top: 40px;">
                                <a href="{{$url}}" style="display: inline-block; background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 50%, #ec4899 100%); color: #ffffff; text-decoration: none; padding: 18px 55px; border-radius: 14px; font-weight: 600; font-size: 16px; box-shadow: 0 10px 40px rgba(139,92,246,0.5), 0 0 20px rgba(236,72,153,0.3);">✨ Enter {{$name}}</a>
                            </div>
                        </td>
                    </tr>
                    <!-- Aurora Footer -->
