{{-- Royal Purple Template - Subscription Expiry Reminder --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <table role="presentation" style="width: 580px; max-width: 100%; border-collapse: collapse; background: #ffffff; border-radius: 4px; overflow: hidden; box-shadow: 0 15px 50px rgba(126,34,206,0.15); border: 2px solid #d4af37;">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #7e22ce 0%, #581c87 100%); padding: 50px 40px; text-align: center;">
                            <div style="color: #d4af37; font-size: 14px; letter-spacing: 4px; margin-bottom: 15px;">✦ URGENT ✦</div>
                            <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: 400; font-family: Georgia, serif;">⏰ Expiry Notice</h1>
                        </td>
                    </tr>
                    <!-- Gold Accent -->
                    <tr>
                        ...
                        <td style="padding: 45px;">
                            ...
                            <div style="background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border: 2px solid #d4af37; padding: 20px; margin: 25px 0;">
                                <p style="color: #92400e; font-size: 16px; font-weight: 600; margin: 0; text-align: center;">
                                    👑 Your royal subscription expires in <strong>24 hours</strong>!
                                </p>
                            </div>
                            <p style="color: #6b7280; font-size: 15px; line-height: 1.8; margin: 20px 0 0;">Renew your royal privileges to maintain uninterrupted service.</p>
                            <div style="text-align: center; margin-top: 40px;">
                                <a href="{{$url}}" style="display: inline-block; background: linear-gradient(135deg, #d4af37 0%, #c9a227 100%); color: #581c87; text-decoration: none; padding: 16px 50px; font-weight: bold; font-size: 14px; letter-spacing: 1px; border-radius: 2px;">👑 RENEW NOW</a>
                            </div>
                            <p style="color: #9ca3af; font-size: 14px; text-align: center; margin: 25px 0 0;">Already renewed? Your throne awaits!</p>
                        </td>
                    </tr>
                    <!-- Royal Footer -->
                    <tr>
