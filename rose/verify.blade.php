{{-- Rose Gold Template - Email Verification --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <table role="presentation" style="width: 580px; max-width: 100%; border-collapse: collapse; background: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 15px 50px rgba(244,63,94,0.12);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #e11d48 100%); padding: 50px 40px; text-align: center;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 26px; font-weight: 500;">💕 Email Verification</h1>
                        </td>
                    </tr>
                    <!-- Rose Accent -->
                    <tr>
                    ...
                    <tr>
                        <td style="padding: 45px;">
                            ...
                            <p style="color: #64748b; font-size: 16px; line-height: 1.8; margin: 0 0 30px;">Here's your verification code. It blooms for 5 minutes!</p>
                            <div style="text-align: center; margin: 35px 0;">
                                <div style="display: inline-block; background: linear-gradient(135deg, #fb7185 0%, #f43f5e 100%); padding: 25px 50px; border-radius: 20px; box-shadow: 0 8px 25px rgba(244,63,94,0.35);">
                                    <span style="color: #ffffff; font-size: 36px; font-weight: bold; letter-spacing: 10px;">{{$code}}</span>
                                </div>
                            </div>
                            <p style="color: #a1a1aa; font-size: 14px; text-align: center; margin: 25px 0 0;">Didn't request this? Just ignore it 💝</p>
                            <div style="text-align: center; margin-top: 40px;">
                                <a href="{{$url}}" style="display: inline-block; background: linear-gradient(135deg, #fb7185 0%, #f43f5e 100%); color: #ffffff; text-decoration: none; padding: 16px 55px; border-radius: 50px; font-weight: 600; font-size: 16px; box-shadow: 0 8px 25px rgba(244,63,94,0.35);">🌹 Visit {{$name}}</a>
                            </div>
                        </td>
                    </tr>
                    <!-- Rose Footer -->
