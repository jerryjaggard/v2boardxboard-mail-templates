{{-- Rose Gold Template - Traffic Warning --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <table role="presentation" style="width: 580px; max-width: 100%; border-collapse: collapse; background: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 15px 50px rgba(244,63,94,0.12);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #fb7185 0%, #f43f5e 50%, #e11d48 100%); padding: 50px 40px; text-align: center;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 26px; font-weight: 500;">📊 Traffic Alert</h1>
                        </td>
                    </tr>
                    <!-- Rose Accent -->
                    <tr>
                        ...
                        <td style="padding: 45px;">
                            ...
                            <div style="background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border-left: 4px solid #f43f5e; padding: 20px; border-radius: 0 16px 16px 0; margin: 25px 0;">
                                <p style="color: #92400e; font-size: 16px; font-weight: 600; margin: 0;">
                                    🌹 You've used <strong>80%</strong> of your lovely traffic!
                                </p>
                            </div>
                            <!-- Rose Progress Bar -->
                            <div style="margin: 30px 0;">
                                <div style="background: #ffe4e6; border-radius: 20px; height: 20px; overflow: hidden;">
                                    <div style="background: linear-gradient(135deg, #fb7185 0%, #f43f5e 100%); width: 80%; height: 100%; border-radius: 20px;"></div>
                                </div>
                                <p style="color: #71717a; font-size: 14px; text-align: center; margin: 12px 0 0;">80% picked • Cherish the remaining petals 🌺</p>
                            </div>
                            <div style="text-align: center; margin-top: 40px;">
                                <a href="{{$url}}" style="display: inline-block; background: linear-gradient(135deg, #fb7185 0%, #f43f5e 100%); color: #ffffff; text-decoration: none; padding: 16px 55px; border-radius: 50px; font-weight: 600; font-size: 16px; box-shadow: 0 8px 25px rgba(244,63,94,0.35);">🌷 View Details</a>
                            </div>
                        </td>
                    </tr>
                    <!-- Rose Footer -->
